...
1. Clone the repository and open it in a supported Java IDE. 
    1. If a student id familiar with Git, they may consider making their own fork.
    2. Otherwise, student changes can be made in a local branch as demonstrated in class. 
